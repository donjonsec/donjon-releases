#!/usr/bin/env python3
"""
Donjon Platform - Terminal UI Components
...
class TUI:
    ...
    def clear(self):
        """Clear the terminal. Uses hardcoded 'clear'/'cls' only — no user input."""
...
if __name__ == "__main__":
    # Demo
    tui.clear()
    tui.banner("DONJON PLATFORM", "GRC & Security Assessment")
