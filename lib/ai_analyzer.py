#!/usr/bin/env python3
"""
Donjon Platform - AI-Powered Analysis Engine
...
class AIAnalyzer:
    """
    AI-powered analysis engine for Donjon findings.
    ...
    def _call_ollama(self, prompt: str) -> str:
        ...
        url = _validate_url(f"{self.api_url.rstrip('/')}/api/generate")
    ...
    def _call_openai(self, prompt: str) -> str:
        ...
        url = _validate_url(f"{self.api_url.rstrip('/')}/chat/completions")
            ...
            'messages': [
                {
                    'role': 'system',
                    'content': (
                        'You are a cybersecurity analyst assistant for the Donjon '
