#!/usr/bin/env python3
"""
Donjon - Container Security Scanner
            ...
            for port_spec, bindings in (ports_cfg or {}).items():
                if bindings:
                    for binding in bindings:
                        ...
                        # nosec B104 - 0.0.0.0 comparison is intentional:
                        # detecting containers bound to all interfaces is a
                        # security finding the scanner must report.
                        if host_ip in ('', '0.0.0.0'):  # nosec B104
                            exposed_ports.append({
                                'container': ctr_name,
                                'port': port_spec,
                                'host_ip': host_ip or '0.0.0.0',  # nosec B104
