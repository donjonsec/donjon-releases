...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by Donjon v7.0 on {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S UTC')}</p>
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by Donjon v6.0 on {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S UTC')}</p>
        </div>
    </div>
</body>
</html>"""
